            ...
            <div
                ...
                <div class="flex flex-col gap-3">
                    ...
                    @forelse ($course->course_videos as $video)
                        @php
                            $currentVideoId = Route::current()->parameter('courseVideo');
                        ...
                        <a href="{{ route('front.learning', [$course, 'courseVideo' => $video->id]) }}">
                            <p
                        ...
                        <div id="Resources" class="tabcontent hidden">
                            <div class="flex flex-col gap-5 w-[700px] shrink-0">
                                ...
                                <p class="font-medium leading-[30px]">
                                    ...
                                    accusantium
                                    quia exercitationem reiciendis? Doloribus, voluptate natus voluptas deserunt
                                    aliquam
                            ...
                            <div class="flex items-center justify-between w-full">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex flex-col gap-[2px]">
                                        ...
                                        <p class="text-sm text-[#6D7786]">{{ $course->category->name }}</p>
                                    </div>
                                </div>
                                <a href=""
